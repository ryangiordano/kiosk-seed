...
(function (g) {
  var k = g.each,
    ...
    this.init(b, a);
      ...
      this.options = b;this.chartOptions = a;this.columns = b.columns || this.rowsToColumns(b.rows) || [];this.firstRowAsNames = t(b.firstRowAsNames, !0);this.decimalRegex = b.decimalPoint && RegExp("^([0-9]+)" + b.decimalPoint + "([0-9]+)$");this.rawColumns = [];this.columns.length ? this.dataFound() : (this.parseCSV(), this.parseTable(), this.parseGoogleSpreadsheet());
      ...
      var b = this.chartOptions,
        ...
        var e = new j(),
            o,
            q = c[n] || f(d),
            m = g.seriesTypes[((b && b.series || [])[n] || {}).type || d || "line"].prototype.pointArrayMap || ["y"];e.addColumnReader(a.x, "x");for (o in a) {
      ...
      if (this.options.switchRowsAndColumns) this.columns = this.rowsToColumns(this.columns);this.getColumnDistribution();this.parseTypes();this.parsed() !== !1 && this.complete();
      ...
      var b = this,
        ...
        var g = b.trim(a),
            v = g.indexOf("#") === 0;e >= d && e <= c && !v && g !== "" && (g = a.split(i), k(g, function (b, a) {
      ...
      var b = this.options,
          ...
          c = b.startColumn || 0,
          h = b.endColumn || Number.MAX_VALUE;a && (typeof a === "string" && (a = document.getElementById(a)), k(a.getElementsByTagName("tr"), function (b, a) {
      ...
      var b = this,
          ...
          n = a.endColumn || Number.MAX_VALUE,
          i,
          g;e && jQuery.ajax({ dataType: "json", url: "https://spreadsheets.google.com/feeds/cells/" + e + "/" + (a.googleSpreadsheetWorksheet || "od6") + "/public/values?alt=json-in-script&callback=?", error: a.error, success: function success(a) {
          var a = a.feed.entry,
              e,
              k = a.length,
              m = 0,
            ...
            if (e = a[l], i = e.gs$cell.row - 1, g = e.gs$cell.col - 1, g >= h && g <= n && i >= d && i <= c) f[g - h][i - d] = e.content.$t;
          }b.dataFound();
        } });
      ...
      var e = this.rawColumns,
          ...
          j = r(a, this.valueCount.xColumns) !== -1,
          o = [],
          q = this.chartOptions,
          m,
          p = (this.options.columnTypes || [])[a],
          q = j && (q && q.xAxis && u(q.xAxis)[0].type === "category" || p === "string");for (e[a] || (e[a] = []); d--;) {
      ...
      }j && b.mixed && (f[a] = e[a]);if (j && m && this.options.sort) for (a = 0; a < f.length; a++) {
        f[a].reverse(), k && f[a].unshift(f[a].pop());
      }
    }, dateFormats: { "YYYY-mm-dd": { regex: /^([0-9]{4})[\-\/\.]([0-9]{2})[\-\/\.]([0-9]{2})$/, parser: function parser(b) {
      ...
      var a = this.options.parseDate,
        ...
        }c || (c = Date.parse(b), (typeof c === "undefined" ? "undefined" : _typeof(c)) === "object" && c !== null && c.getTime ? e = c.getTime() - c.getTimezoneOffset() * 6E4 : typeof c === "number" && !isNaN(c) && (e = c - new Date(c).getTimezoneOffset() * 6E4));
      }return e;
      ...
      var b = this.columns,
        ...
        for (c = 0; c < b.length; c++) {
          ...
          i = new j();i.addColumnReader(0, "x");c = r(0, d);c !== -1 && d.splice(c, 1);for (c = 0; c < this.valueCount.global; c++) {
